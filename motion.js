function motion() {
  ...
  if (app == 1) {
    motion_case(1, 4, politics, study, diplomacy, 1, false);
    motion_case(2, 4, politics, study, diplomacy, 1, false);
    motion_case(3, 3, politics, study, diplomacy, 1, false);
    motion_case(4, 2, politics, study, diplomacy, 1, false);
  } else if (app == 2) {
...
function wars(V, Y, X, player, value) {
  if (value == V && map[Y][X] != data.color[player]) {
    map_war = map[Y][X];
    if (data.army_population[player] * data.rifle[player] >= data.defense[map_war] * data.rifle[map_war]) {
      R(10);
